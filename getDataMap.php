...
<script>
    ...
    sortArrayAlphabetically(sublocations, 'sublocation');
    sortArrayAlphabetically(categories, 'category');

    function sortArrayAlphabetically(array, parameter){
        array.sort(function(a, b) {
            let locA = a[parameter].toLowerCase(),
                locB = b[parameter].toLowerCase();
            if (locA < locB)
                return -1;
            if (locB > locB)
                return 1;
